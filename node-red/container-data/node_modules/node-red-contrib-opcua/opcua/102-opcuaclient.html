...
<script type="text/x-red" data-template-name="OpcUa-Client">
    ...
    <div class="form-row" id="node-input-servercertificate">
        ...
        <select id="node-input-certificate" style="width:72%;">
            ...
            <option value="l">Local certifikate file, give path with filename (pem)</option>
        </select>
    </div>
	<div class="form-row">
...
<script type="text/x-red" data-help-name="OpcUa-Client">
    ...
    <p> msg.range = "2:4" and FloatArray or any Array datatype then indexes from 2 to 4 will be used to read or write depending on action</p>
</script>
